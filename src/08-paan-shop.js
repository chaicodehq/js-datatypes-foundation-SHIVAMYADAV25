...
export function updatePrices(menu, increase) {
  ...
  const updated = Object.entries(menu).map(([item, price]) => {
...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  const r = (typeof regularMenu === "object" && regularMenu !== null && !Array.isArray(regularMenu))
    ? regularMenu
    : {};

  const s = (typeof specialsMenu === "object" && specialsMenu !== null && !Array.isArray(specialsMenu))
    ? specialsMenu
    : {};
